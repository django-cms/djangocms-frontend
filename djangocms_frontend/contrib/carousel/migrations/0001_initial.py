            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_carousel_bootstrap5carousel",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        help_text="This is the template that will be used for the component.",
                        max_length=255,
                ...
                (
                    ...
                    models.IntegerField(
                        default=5000,
                        help_text="The amount of time to delay between automatically cycling an item. If false, carousel will not automatically cycle.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Adding in the previous and next controls.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Adding in the indicators to the carousel.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether the carousel should react to keyboard events.",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text='If set to "hover", pauses the cycling of the carousel on "mouseenter" and resumes the cycling of the carousel on "mouseleave". If set to "false", hovering over the carousel won\'t pause it.',
                        max_length=255,
                        verbose_name="Pause",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        help_text='Autoplays the carousel after the user manually cycles the first item. If "carousel", autoplays the carousel on load.',
                        max_length=255,
                        verbose_name="Ride",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether the carousel should cycle continuously or have hard stops.",
                        verbose_name="Wrap",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_carousel_bootstrap5carouselslide",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
