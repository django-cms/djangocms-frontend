            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_grid_bootstrap5gridcolumn",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
                ...
                (
                    "column_size",
                    djangocms_frontend.fields.IntegerRangeField(
                        blank=True,
                        help_text="Nummeric value from 1 - 12. Spreads the columns evenly when empty.",
                        null=True,
                ...
                (
                    "xs_col",
                    djangocms_frontend.fields.IntegerRangeField(blank=True, null=True),
                ),
                (
                    "xs_order",
                    djangocms_frontend.fields.IntegerRangeField(blank=True, null=True),
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_grid_bootstrap5gridcontainer",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Defines if the grid should use fixed width (<code>.container</code>) or fluid width (<code>.container-fluid</code>).",
                        max_length=255,
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_grid_bootstrap5gridrow",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        help_text='Read more in the <a href="https://getbootstrap.com/docs/5.0/layout/grid/#vertical-alignment" target="_blank">documentation</a>.',
                        max_length=255,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text='Read more in the <a href="https://getbootstrap.com/docs/5.0/layout/grid/#horizontal-alignment" target="_blank">documentation</a>.',
                        max_length=255,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Removes the marginal gutters from the grid.",
                        verbose_name="Remove gutters",
                    ),
                ),
                (
                    "tag_type",
