...
def migrate_column_size(apps, schema_editor):  # pragma: no cover
    Column = apps.get_model("grid", "Bootstrap5GridColumn")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("grid", "0002_auto_20180709_0808"),
    ]

    operations = [migrations.RunPython(migrate_column_size, migrate_column_size_back)]
