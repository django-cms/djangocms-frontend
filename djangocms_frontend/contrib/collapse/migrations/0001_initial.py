            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_collapse_bootstrap5collapse",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default=".card",
                        help_text="Element to be used to create accordions.",
                        max_length=255,
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_collapse_bootstrap5collapsecontainer",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
                (
                    "identifier",
                    models.SlugField(
                        help_text="Identifier to connect trigger with container.",
                        max_length=255,
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        parent_link=True,
                        primary_key=True,
                        related_name="bootstrap5_collapse_bootstrap5collapsetrigger",
                        serialize=False,
                        to="cms.CMSPlugin",
                    ),
                ),
