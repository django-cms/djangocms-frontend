...
SHOW_ADVANCED_SETTINGS = getattr(django_settings, "DJANGOCMS_FRONTEND_SHOW_ADVANCED_SETTINGS", True)

AUTO_TEXT_CONTRAST = getattr(django_settings, "DJANGOCMS_FRONTEND_AUTO_TEXT_CONTRAST", True)
